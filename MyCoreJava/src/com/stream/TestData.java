...
public class TestData {
	...
	public static List<Fruit> getAllFruits() {
		...
		fruits.add(new Fruit("Pomegranate", 500, 70, "Red"));
		fruits.add(new Fruit("Apple", 300, 150, "Red"));
		fruits.add(new Fruit("Watermelon", 30, 20, "Red"));
		fruits.add(new Fruit("Guava", 500, 40, "Green"));
		fruits.add(new Fruit("Mango", 50, 100, "Yellow"));
		return fruits;
	}
	...
	public static List<Transaction> getAllTransactions() {
		...
		transactions.add(new Transaction(new Trader("Surendra", "Delhi"), 2011, 55000));
		...
		transactions.add(new Transaction(new Trader("Gourav", "Delhi"), 2018, 90000));
		return transactions;
	}
